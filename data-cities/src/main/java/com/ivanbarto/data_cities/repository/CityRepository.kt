...
interface CityRepository {
    ...
    suspend fun getCitiesByPrefix(prefix: String): List<CityDto>
    suspend fun getFavoriteCitiesByPrefix(prefix: String): List<CityDto>
    suspend fun getFavoriteCities(): List<CityDto>
